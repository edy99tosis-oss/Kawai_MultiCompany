...
Begin VB.Form frm_BrowseSupp 
   ...
   Begin VSFlex8Ctl.VSFlexGrid gridSearch 
      ...
      FormatString    =   $"frm_BrowseSupp.frx":0E42
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "frm_BrowseSupp"
...
Public Sub IsiGrid()
    ...
    query = "Select rtrim(trade_code) as TC,Trade_name as TN, Address1 as A from trade_master where trade_cls in ('2', '3') order by trade_code"
...
Public Sub Header()
    With gridSearch
        .TextMatrix(0, 0) = "Supplier Code"
        .TextMatrix(0, 1) = "Supplier Name"
