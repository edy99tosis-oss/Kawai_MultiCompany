...
Begin VB.Form frmBC27BrowseBeaMasukTambahan 
   BackColor       =   &H00FDDFE3&
   ...
   EndProperty
   Icon            =   "frmBC27BrowseBeaMasukTambahan.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8250
   ...
   End
End
Attribute VB_Name = "frmBC27BrowseBeaMasukTambahan"
...
Public Sub up_LoadData(pNoPengajuan As String, pNoSeri As Integer)
    ...
    cmd.CommandText = "sp_BC27DetailBeaMasukTambahan_Sel"
...
Public Sub up_LoadDataBahanBaku(pNoPengajuan As String, pNoSeriBarang As Integer, pNoSeriBahanBaku As Integer, pKodeAsal As Integer)
    ...
    cmd.CommandTimeout = 0
    cmd.ActiveConnection = Db
    cmd.CommandText = "sp_BC27DetailBeaMasukTambahanBahanBaku_Sel"
...
Private Sub up_Delete(pKodeTarif As String)
    ...
    cmd.CommandTimeout = 0
    cmd.ActiveConnection = Db
    cmd.CommandText = "sp_BC27DetailBeaMasukTambahan_Del"
...
Private Sub up_DeleteBahanBaku(pKodeTarif As String)
    ...
    cmd.CommandTimeout = 0
    cmd.ActiveConnection = Db
    cmd.CommandText = "sp_BC27DetailBeaMasukTambahanBahanBaku_Del"
...
cmd.CommandTimeout = 0
cmd.ActiveConnection = Db
cmd.CommandText = "sp_BC27DetailBeaMasukTambahanBahanBaku_Upd"
...
cmd.Execute Y
    ...
    If Y = 0 Then
        ...
        cmd.CommandTimeout = 0
        cmd.ActiveConnection = Db
        cmd.CommandText = "sp_BC27DetailBeaMasukTambahanBahanBaku_Ins"
...
'cmd.CommandTimeout = 0
'cmd.ActiveConnection = Db
'cmd.CommandText = "sp_BC27DetailPungutan_Upd"
'
'Set prm1 = cmd.CreateParameter("NoPengajuan", adVarChar, adParamInput, 50, txtNoPengajuan)
'cmd.Parameters.append prm1
'Set prm2 = cmd.CreateParameter("NoSeri", adInteger, adParamInput, 5, txtNoSeri)
...
'    cmd.CommandTimeout = 0
'    cmd.ActiveConnection = Db
'    cmd.CommandText = "sp_BC27DetailPungutan_Ins"
'
'    Set prm1 = cmd.CreateParameter("NoPengajuan", adVarChar, adParamInput, 50, txtNoPengajuan)
'    cmd.Parameters.append prm1
'    Set prm2 = cmd.CreateParameter("NoSeri", adInteger, adParamInput, 5, txtNoSeri)
...
cmd.CommandTimeout = 0
cmd.ActiveConnection = Db
cmd.CommandText = "sp_BC27DetailBeaMasukTambahan_Upd"
...
cmd.Execute Y
    ...
    If Y = 0 Then
        ...
        cmd.CommandTimeout = 0
        cmd.ActiveConnection = Db
        cmd.CommandText = "sp_BC27DetailBeaMasukTambahan_Ins"
