...
Begin VB.Form frmBC25BrowseDokumen 
   BackColor       =   &H00FDDFE3&
   Caption         =   "Dokumen"
   ClientHeight    =   6390
   ClientLeft      =   60
   ...
   EndProperty
   Icon            =   "frmBC25BrowseDokumen.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   6390
   ScaleWidth      =   8835
   ...
   End
End
Attribute VB_Name = "frmBC25BrowseDokumen"
...
Dim RS As ADODB.Recordset
    ...
    With Grid
        While Not RS.EOF
            ...
            .TextMatrix(li_Row, colHideID) = Trim(RS!Seri_Dokumen)
...
Private Sub up_Delete()
    ...
    cmd.Parameters.append cmd.CreateParameter("NoPengajuan", adVarChar, adParamInput, 50, txtNoAju)
    cmd.Parameters.append cmd.CreateParameter("Seri_Dokumen", adInteger, adParamInput, , txtID)
    cmd.Execute
