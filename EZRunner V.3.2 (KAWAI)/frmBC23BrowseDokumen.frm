...
Begin VB.Form frmBC23BrowseDokumen 
   BackColor       =   &H00FDDFE3&
   ...
   EndProperty
   Icon            =   "frmBC23BrowseDokumen.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6420
   ...
   End
End
Attribute VB_Name = "frmBC23BrowseDokumen"
...
Private Sub up_SaveData()
    ...
    cmd.CommandTimeout = 0
    cmd.ActiveConnection = Db
    cmd.CommandText = "sp_BC23TPBDokumen_Upd"
    ...
    If Y = 0 Then
        ...
        cmd.CommandTimeout = 0
        cmd.ActiveConnection = Db
        cmd.CommandText = "sp_BC23TPBDokumen_Ins"
...
Private Sub up_Delete()
    ...
    cmd.CommandTimeout = 0
    cmd.ActiveConnection = Db
    cmd.CommandText = "sp_BC23TPBDokumen_Del"
