...
Begin VB.Form frm_BrowseItemCode 
   BackColor       =   &H00FDDFE3&
   ...
   EndProperty
   Icon            =   "frm_BrowseItemCode.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   30699.8
   ScaleMode       =   0  'User
   ScaleWidth      =   17347.95
   ...
   Begin VSFlex8Ctl.VSFlexGrid gridSearch 
      ...
      FormatString    =   $"frm_BrowseItemCode.frx":0E42
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "frm_BrowseItemCode"
...
Public Sub IsiGrid()
    ...
    query = "Select * From item_master where FinishGoodPart_Cls='01'"
