...
Private Sub up_GridLoad()
    ...
    cmd.CommandText = "sp_BC25List_Sel"
...
Private Sub up_CreateNoPengajuan()
    ...
    For i = 1 To grid.Rows - 1
        If grid.Cell(flexcpChecked, i, ColCheck) = flexChecked Then
            ...
            cmd.CommandTimeout = 0
            cmd.ActiveConnection = Db
            cmd.CommandText = "sp_BC25ListGenerateNoAju_Sel"
...
ElseIf Index = 2 Then
    If grid.TextMatrix(grid.RowSel, colNoPengajuan) = "" Then
        Exit Sub
    End If
    frmBC25Detail.txtNoPengajuan.Text = grid.TextMatrix(grid.RowSel, colNoPengajuan)
    frmBC25Detail.up_LoadDataBC25 (grid.TextMatrix(grid.RowSel, colNoPengajuan))
