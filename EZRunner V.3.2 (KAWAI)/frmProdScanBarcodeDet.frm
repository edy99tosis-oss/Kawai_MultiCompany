VERSION 5.00
Begin VB.Form frmProdScanBarcodeDet 
   BackColor       =   &H00FDDFE3&
   ...
   ClientTop       =   6705
   ClientWidth     =   6885
   Icon            =   "frmProdScanBarcodeDet.frx":0000
   KeyPreview      =   -1  'True
   LinkMode        =   1  'Source
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmProdScanBarcodeDet"
...
Call FrmProdResultDetail.CheckSerial(StrItem, strSerial)
