...
Begin VB.Form FrmBCLoadBarang 
   ...
   End
End
Attribute VB_Name = "FrmBCLoadBarang"
   ...
   k = False
    With GridBarang
        ...
        If TextGrid = "S" Then
            ...
            FrmBC41Detail.txtHargaPenyerahan.Text = .TextMatrix(Row, bteColHarga)
            ...
            FrmBC41Detail.txtHargaPenyerahan.Enabled = True
            FrmBC41Detail.txtNoAju.Enabled = True
            
                        
            FrmBCLoadBarang.Hide
