...
Begin VB.Form frmPORequestInquiry 
   BackColor       =   &H00FDDFE3&
   ...
   EndProperty
   Icon            =   "frmPORequestInquiry.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   11010
   ScaleWidth      =   15240
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox CboType 
         Height          =   315
         ItemData        =   "frmPORequestInquiry.frx":0E42
         Left            =   1920
         List            =   "frmPORequestInquiry.frx":0E4F
      ...
      Begin VB.ComboBox CboRem 
         Height          =   315
         ItemData        =   "frmPORequestInquiry.frx":0E74
         Left            =   1935
         List            =   "frmPORequestInquiry.frx":0E81
         Style           =   2  'Dropdown List
         TabIndex        =   5
         Top             =   1950
         Width           =   885
   ...
   End
End
Attribute VB_Name = "frmPORequestInquiry"
...
With grid
    ...
    Sql = " Select  " & _
                ...
                "                       PD.Item_Name) AS Item_name, PM.Others_Cls, ISNULL(I.Unit_Cls, PD.Unit_Cls) AS Unit_Cls, PD.Qty AS ReqQty, ISNULL " & _
                "                           ((SELECT     SUM(Qty) " & _
                "                               FROM         PurchaseOrder_Master POM, PurchaseOrder_Detail POD " & _
                "                               WHERE     POM.PO_No = POD.PO_No AND POD.PORequest_No = PM.PORequest_No AND POD.POReq_Seqno = PD.seq_no), 0) AS totPO " & _
