...
Begin VB.Form frm_BrowseItem 
   ...
   Begin VSFlex8Ctl.VSFlexGrid gridSearch 
      ...
      FormatString    =   $"frm_BrowseItem.frx":0E42
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "frm_BrowseItem"
...
Public Sub IsiGrid()
    ...
    query = "select makeritem_code, item_code, item_name from item_master"
    ...
    While Not RS.EOF
        ...
        i = i + 1
        .AddItem ""
        .TextMatrix(i, 0) = Trim(RS!MakerItem_Code & "")
        .TextMatrix(i, 1) = Trim(RS!Item_Code & "")
...
'    RS.MoveFirst
'    Do Until RS.EOF
'     ' List1.AddItem (rs!itemID)
'      '  MSFlexGrid1.AddItem (rs!ItemID) '-----------This line is working fine
...
Private Sub gridSearch_RowColChange()
    LblErrMsg.Caption = "Item Code = " & gridSearch.TextMatrix(gridSearch.RowSel, 1)
End Sub
