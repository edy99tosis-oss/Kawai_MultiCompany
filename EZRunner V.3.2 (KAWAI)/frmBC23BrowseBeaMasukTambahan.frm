...
Begin VB.Form frmBC23BrowseBeaMasukTambahan 
   BackColor       =   &H00FDDFE3&
   ...
   EndProperty
   Icon            =   "frmBC23BrowseBeaMasukTambahan.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8280
   ...
   End
End
Attribute VB_Name = "frmBC23BrowseBeaMasukTambahan"
...
Public Sub up_LoadData(pNoPengajuan As String, pNoSeri As Integer)
    ...
    cmd.CommandText = "sp_BC23DetailBeaMasukTambahan_Sel"
