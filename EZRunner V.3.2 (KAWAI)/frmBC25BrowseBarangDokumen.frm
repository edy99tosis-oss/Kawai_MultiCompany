...
Begin VB.Form frmBC25BrowseBarangDokumen 
   BackColor       =   &H00FDDFE3&
   ...
   EndProperty
   Icon            =   "frmBC25BrowseBarangDokumen.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   5580
   ScaleWidth      =   13020
   StartUpPosition =   3  'Windows Default
   Begin VB.TextBox txtKodeAsalBahanBaku 
      Height          =   375
      Left            =   12120
      TabIndex        =   13
      Top             =   4920
   ...
   End
End
Attribute VB_Name = "frmBC25BrowseBarangDokumen"
...
Dim RS As ADODB.Recordset
    ...
    Else
        ...
        cmd.Parameters.append cmd.CreateParameter("NoPengajuan", adVarChar, adParamInput, 50, txtNoPengajuan.Text)
        cmd.Parameters.append cmd.CreateParameter("NoSeriBarang", adVarChar, adParamInput, 5, txtNoSeri.Text)
        cmd.Parameters.append cmd.CreateParameter("NoSeriBahanBaku", adVarChar, adParamInput, 5, txtNoSeriBahanBaku.Text)
        cmd.Parameters.append cmd.CreateParameter("KodeAsal", adVarChar, adParamInput, 5, txtKodeAsalBahanBaku.Text)
    End If
...
Private Sub up_AddDokumen()
    ...
    cmd.ActiveConnection = Db
    If txtKodeAsalBahanBaku = "" Then
        cmd.CommandText = "sp_BC25DetailBarangDokumen_Ins"
    ...
    Else
        cmd.CommandText = "sp_BC25DetailBahanBakuDokumen_Ins"
        cmd.Parameters.append cmd.CreateParameter("NoPengajuan", adVarChar, adParamInput, 50, txtNoPengajuan)
        cmd.Parameters.append cmd.CreateParameter("NoSeriBarang", adVarChar, adParamInput, 50, txtNoSeri)
        cmd.Parameters.append cmd.CreateParameter("NoSeriDokumen", adInteger, adParamInput, 5, gridSumber.TextMatrix(gridSumber.RowSel, colNoSumber))
        cmd.Parameters.append cmd.CreateParameter("NoSeriBahanBaku", adInteger, adParamInput, 5, txtNoSeriBahanBaku)
        cmd.Parameters.append cmd.CreateParameter("KodeAsal", adInteger, adParamInput, 5, txtKodeAsalBahanBaku)
...
Private Sub cmdDelete_Click()
    ...
    If txtKodeAsalBahanBaku <> "" Then
        cmd.CommandText = "sp_BC25DetailBahanBakuDokumen_Del"
        ...
        cmd.Parameters.append cmd.CreateParameter("NoSeriDokumen", adInteger, adParamInput, 5, txtNoSeriBahanBaku)
        cmd.Parameters.append cmd.CreateParameter("NoSeriDokumen", adInteger, adParamInput, 5, txtKodeAsalBahanBaku)
    
    Else
       
        cmd.CommandText = "sp_BC25DetailBarangDokumen_Del"
